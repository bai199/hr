...
<html>
	...
	<body>
		<div class="container">	
			...
			<form class="form-horizontal" id="form1" method="post" action ="UpdateDeptServlet">
				<div class="form-group">
					<label for="" class="col-md-2">部门名称</label>
					<div class="col-md-10">
						<input id="deptName" value="${dept.deptName }" name="deptName" type="text" placeholder="请输入部门名称" class="form-control"/>
					</div>					
				</div>	
				<div class="form-group">
					<label for="" class="col-md-2">部门地址</label>
					<div class="col-md-10">
						<input id="deptLoc" value="${dept.deptLoc }" name="deptLoc" type="text" placeholder="请输入部门地址" class="form-control"/>
					</div>					
				</div>
